...
async function callGeminiSingle({ apiKey, modelName, systemPrompt, userPrompt, jsonMode, timeoutMs, temperature, maxOutputTokens }) {
    ...
    const callPromise = model.generateContent(userPrompt).then(result => {
