...
- requisites (слева): финальный блок реквизитов/подписей — по одному блоку на строку (название стороны, реквизиты, строка подписи)
- spacer (runs:[])
...
• В конце — раздел «РЕКВИЗИТЫ И ПОДПИСИ СТОРОН»: для каждой стороны её реквизиты и строка подписи (kind requisites).
